...
const routerMap = {
  ...
  pricing: '/pricing',
  task: '/console/task',
  task_setting: '/console/task-setting',
  external_user_source: '/console/external-user-source',
...
const SiderBar = ({ onNavigate = () => {} }) => {
  ...
  const adminItems = useMemo(() => {
    const items = [
      ...
      {
        text: t('定时任务'),
        itemKey: 'task_setting',
        to: '/task-setting',
        className: isAdmin() ? '' : 'tableHiddle',
      },
      {
        text: t('外部用户源'),
        itemKey: 'external_user_source',
        to: '/external-user-source',
        className: isAdmin() ? '' : 'tableHiddle'
      },
    ];
