...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.HEAD("/status", controller.GetStatus)
		apiRouter.GET("/uptime/status", controller.GetUptimeKumaStatus)
		apiRouter.GET("/models", middleware.UserAuth(), controller.DashboardListModels)
		apiRouter.GET("/status/test", middleware.AdminAuth(), controller.TestStatus)
		apiRouter.GET("/notice", controller.GetNotice)
		// News routes (public)
		apiRouter.GET("/news", controller.GetNewsList)
		apiRouter.GET("/news/:id", controller.GetNewsDetail)
		...
		cronTaskRoute := apiRouter.Group("/cron-task")
		cronTaskRoute.Use(middleware.AdminAuth())
		{
			cronTaskRoute.GET("/", controller.GetAllCronTasks)
			cronTaskRoute.GET("/:id", controller.GetCronTask)
			cronTaskRoute.PUT("/:id", controller.UpdateCronTask)
			cronTaskRoute.POST("/:id/trigger", controller.TriggerCronTask)
			cronTaskRoute.GET("/:id/executions", controller.GetCronTaskExecutions)
		...
		externalUserSourceRoute.GET("/:id/fields", controller.GetExternalTableFields)
		}
		}
		}
		...
		newsRoute := apiRouter.Group("/news")
		newsRoute.Use(middleware.AdminAuth())
		{
			newsRoute.GET("/manage", controller.GetNewsManageList)
			newsRoute.POST("/", controller.CreateNews)
			newsRoute.PUT("/:id", controller.UpdateNews)
			newsRoute.DELETE("/:id", controller.DeleteNews)
		}
		}
	}
}
